...
1. **Create library directory**:
   ```bash
   mkdir -p skills/excalidraw-validated-diagram-generator/libraries/aws-architecture-icons
   ```
...
3. **Run the script**:
   ```bash
   python skills/excalidraw-validated-diagram-generator/scripts/split-excalidraw-library.py skills/excalidraw-validated-diagram-generator/libraries/aws-architecture-icons/
   ```
...
```
skills/excalidraw-validated-diagram-generator/libraries/aws-architecture-icons/
