...
The script expects the following structure:
  skills/excalidraw-validated-diagram-generator/libraries/{icon-set-name}/
...
Example:
    python split-excalidraw-library.py skills/excalidraw-validated-diagram-generator/libraries/aws-architecture-icons/
"""
...
def main():
    ...
    if len(sys.argv) != 2:
        ...
        print("\nExample:")
        print("  python split-excalidraw-library.py skills/excalidraw-validated-diagram-generator/libraries/aws-architecture-icons/")
