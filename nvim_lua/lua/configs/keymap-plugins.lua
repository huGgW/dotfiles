...
vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(ev)
        ...
        vim.keymap.set('n', '<leader>k', vim.lsp.buf.signature_help, addDesc("Show signature help"))
        vim.keymap.set('n', '<space>wa', vim.lsp.buf.add_workspace_folder, addDesc("Add workspace folder"))
        vim.keymap.set('n', '<space>wr', vim.lsp.buf.remove_workspace_folder, addDesc("Remove workspace folder"))
